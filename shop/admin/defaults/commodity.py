...
# from shop.admin.product import UnitPriceMixin
...
#     # class CommodityAdmin(SortableAdminMixin, TranslatableAdmin,
#     class CommodityAdmin(#SortableAdminMixin, TranslatableAdmin,
#                          # PlaceholderAdminMixin, CMSPageAsCategoryMixin, UnitPriceMixin, admin.ModelAdmin):
#                          UnitPriceMixin, admin.ModelAdmin):
#         fieldsets = [
#             (None, {
#                 'fields': [
#                     ('product_name', 'slug'),
...
#     # class CommodityAdmin(SortableAdminMixin,
#     class CommodityAdmin(#SortableAdminMixin,
