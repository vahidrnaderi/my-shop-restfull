class DefaultSettings:
    ...
    def SHOP_CART_MODIFIERS(self):
        ...
        This list typically starts with ``'shop.shopmodifiers.defaults.DefaultCartModifier'`` as its first entry,
        followed by other cart modifiers.
        """
        from django.utils.module_loading import import_string

        cart_modifiers = self._setting('SHOP_CART_MODIFIERS', ['shop.shopmodifiers.defaults.DefaultCartModifier'])
    ...
    def SHOP_VALUE_ADDED_TAX(self):
        ...
        and you use one of the default tax modifiers :class:`shop.shopmodifiers.taxes.CartIncludeTaxModifier`
        or :class:`shop.shopmodifiers.taxes.CartExcludedTaxModifier`.
